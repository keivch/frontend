...
const PopupLlave = ({ edit = false, onClose, onSave, formData: initialFormData }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50">
      <div className="relative bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
        <h2 className="text-lg font-bold mb-4">{edit ? 'Añadir Llave' : 'Ver Llave'}</h2>
